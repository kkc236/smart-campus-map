...
const BUILDING_ALIASES = [
  ...
  { id: 'CD', terms: ['cd', 'c-d', 'cd connector', 'c d connector', 'cd楼', 'cd环'] },
  ...
  { id: 'D', terms: ['d building', 'd block', 'd楼', 'd栋'] },
  { id: 'E', terms: ['e building', 'e楼', 'e栋'] },
  { id: 'F', terms: ['f building', 'f楼', 'f栋'] },
  { id: 'G', terms: ['g building', 'g楼', 'g栋'] },
